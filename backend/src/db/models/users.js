...
module.exports = function (sequelize, DataTypes) {
  ...
  users.associate = (db) => {
    ...
    db.users.hasMany(db.screen_time_recommendations, {
      as: 'screen_time_recommendations_child',
      foreignKey: {
        name: 'childId',
      },
      constraints: false,
    ...
    db.users.hasMany(db.sentiment_check_ins, {
      as: 'sentiment_check_ins_child',
      foreignKey: {
        name: 'childId',
      },
      constraints: false,
