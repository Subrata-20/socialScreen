...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '8c26ca130f332f2439ac1c16ca023787',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'socialScreen <app@flatlogic.app>',
  ...
  project_uuid: 'ca9f641a-756b-446b-a2cf-2e37bfa2918b',
  flHost:
...
config.pexelsQuery = 'children playing in nature';
config.host =
