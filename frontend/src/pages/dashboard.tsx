...
const Dashboard = () => {
  ...
  const [screen_time_recommendations, setScreen_time_recommendations] =
    React.useState('Loading...');
  const [sentiment_check_ins, setSentiment_check_ins] =
    React.useState('Loading...');
  ...
  async function loadData() {
    ...
    const fns = [
      ...
      setAchievements,
      setRewards,
      setScreen_time_recommendations,
      setSentiment_check_ins,
      setTasks,
      setRoles,
      setPermissions,
    ];
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_SCREEN_TIME_RECOMMENDATIONS') && (
            <Link
              href={
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiTimer || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_SENTIMENT_CHECK_INS') && (
            <Link href={'/sentiment_check_ins/sentiment_check_ins-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiEmoticon || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
