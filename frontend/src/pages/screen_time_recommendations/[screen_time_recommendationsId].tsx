...
const EditScreen_time_recommendations = () => {
  ...
  const { screen_time_recommendationsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: screen_time_recommendationsId }));
  }, [screen_time_recommendationsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: screen_time_recommendationsId, data }));
    await router.push(
...
EditScreen_time_recommendations.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditScreen_time_recommendations;
